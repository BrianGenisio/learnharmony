...
!function(){"use strict";function e(e){this.settings=e||{};var t=this.settings.baseUrl||(this.settings.baseUrl=".");t&&"/"!==t[t.length-1]&&(this.settings.baseUrl=t+"/")}var t=require("./file"),s=require("./url");e.prototype.resolve=function(s,i){var r,n,o,a,l,p,u,h,g=this.settings,c=g.urlArgs,f=g.shim||{},m=g.packages||[],b=g.paths||{},U=b[s],v=s.split("!");for(s=v.pop(),l=s.replace(/[\/\\]+/g,"/").split("/"),p=l.shift(),u=l.join("/"),r=0,n=m.length;n>r;r++){if(a=m[r],a===p){U=p+"/main";break}if(a.name===p){U=a.location?a.location+"/":"",U+=p+"/"+(u||a.main||"main");break}}return f.hasOwnProperty(s)&&(h={name:f[s].exports||f[s].name||s,deps:f[s].imports||f[s].deps||[]}),U||(U=s),0===v.length&&/\.js$/.test(U)===!1&&(U+=".js"),i=e.useBase(U)&&i?i:g.baseUrl,o=new t(c?U+"?"+c:U,i),{name:s,file:o,url:o.url,shim:h,plugins:v}},e.useBase=function(t){return"."===t[0]&&("/"===t[1]||"."===t[1]&&"/"===t[2])||e.hasProtocol(t)},e.hasProtocol=function(e){return/^(?:(https?|file)(:\/\/\/?))/g.test(e)},e.File=e.prototype.File=t,e.URL=e.prototype.URL=s,module.exports=e}();
...
!function(){"use strict";function r(r,n){this.url=new e(r,n)}var e=require("./url");r.parseParts=function(r){var e,n=r.replace(/([^/]+)$/gim,function(r){return e=r,""});return{name:e||"",directory:n,path:r}},r.addExtension=function(e,n){var t=r.parseParts(e),a=t.name.split(".");return 1===a.length&&n&&a.push(n),t.directory+a.join(".")},r.replaceExtension=function(r,e){var n=/([^.\/\\]+\.)[^.]+$/;return r.match(n)?r.replace(n,"$1"+e):r+"."+e},module.exports=r}();
},{"./url":8}],8:[function(require,module,exports){
!function(){"use strict";function s(r,t){var o=s.parser.resolve(t||"",r),h=s.parser.parse(o);if(h.auth){var e=h.auth.split(":");h.username=e[0],h.password=e[1]}this.hash=h.hash||"",this.host=h.host||"",this.hostname=h.hostname||"",this.href=h.href,this.origin=h.protocol?h.protocol+"//"+h.host:"",this.password=h.password||"",this.pathname=h.pathname||"",this.port=h.port||"",this.protocol=h.protocol||"",this.search=h.search||"",this.username=h.username||""}var r=require("url");s.factory=function(r,t){return new s(r,t)},s.parser=r,module.exports=s}();
},{"url":6}]},{},[1])(1)
});


//# sourceMappingURL=dist/amd-resolver.min.js.map